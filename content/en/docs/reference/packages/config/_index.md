...
{{% pageinfo %}}
This is the API reference for the `rivaas.dev/config` package. For learning-focused documentation, see the [Config Guide](/docs/guides/config/).
{{% /pageinfo %}}
...
For learning-focused guides, see the [Configuration Guide](/docs/guides/config/).
