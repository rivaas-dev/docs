...
2. Review [Examples](/docs/guides/logging/examples/) for patterns
3. See [Best Practices](/docs/guides/logging/best-practices/) for recommendations
...
- See [Best Practices](/docs/guides/logging/best-practices/) for production guidance
