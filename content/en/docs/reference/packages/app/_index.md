...
{{% pageinfo %}}
This is the API reference for the `rivaas.dev/app` package. For learning-focused documentation, see the [App Guide](/docs/guides/app/).
{{% /pageinfo %}}
...
Only the listed methods are supported; unsupported method causes a panic. See [API Reference](api-reference/) for details.
...
Configure HTTP, HTTPS, or mTLS at construction with [WithTLS](options/#withtls) or [WithMTLS](options/#withmtls).
...
- [Troubleshooting](troubleshooting/) - Common issues and solutions
- [User Guide](/docs/guides/app/) - Learn how to use the app package
