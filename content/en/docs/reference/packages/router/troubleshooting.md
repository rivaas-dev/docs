...
- High throughput (see [Performance](/docs/reference/packages/router/performance/) for current numbers)
...
- **Documentation**: Check the [Router Guide](/docs/guides/router/)
- **Examples**: Browse [working examples](/docs/guides/router/examples/)
...
- **Examples**: Browse [complete examples](/docs/guides/router/examples/)
