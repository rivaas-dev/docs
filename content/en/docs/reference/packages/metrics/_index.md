...
{{% pageinfo %}}
This is the API reference for the `rivaas.dev/metrics` package. For learning-focused documentation, see the [Metrics Guide](/docs/guides/metrics/).
{{% /pageinfo %}}
...
For learning-focused guides, see the [Metrics Guide](/docs/guides/metrics/).
