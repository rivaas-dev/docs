...
{{% pageinfo %}}
This is the API reference for the `rivaas.dev/tracing` package. For learning-focused documentation, see the [Tracing Guide](/docs/guides/tracing/).
{{% /pageinfo %}}
...
Internal operational events are logged via the [slog.Logger] passed to [WithLogger]. Omit `WithLogger` or pass nil to produce no internal output.
...
For learning-focused guides, see the [Tracing Guide](/docs/guides/tracing/).
