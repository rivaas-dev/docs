...
💡 **Note**: This section covers observability setup. For detailed observability patterns, see the [Observability Guide](/docs/guides/app/observability/).
...
- **[Routing Guide](/docs/guides/router/)** — Advanced routing patterns
- **[Observability Guide](/docs/guides/app/observability/)** — Deep dive into logging, metrics, tracing
- **[Package Documentation](/docs/reference/packages/app/)** — Complete API reference

## Reference

For a complete list of all configuration options, see the [App Options Reference](/docs/reference/packages/app/options/).
