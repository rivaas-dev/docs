...
Check the [Middleware Reference](/docs/reference/packages/router/middleware/) for complete documentation.
...
See the [Middleware Reference](/docs/reference/packages/router/middleware/) for the full list and a `go get` command for each package.
...
- **[Middleware Reference →](/docs/reference/packages/router/middleware/)** — All 12 middleware with examples
- **[Router Middleware Guide →](/docs/guides/router/middleware/)** — Build your own middleware
