...
- Check [API Reference](/docs/reference/packages/tracing/api-reference/) for all methods
- Review [Troubleshooting](/docs/reference/packages/tracing/troubleshooting/) for common issues
