...
- Review [API Reference](/docs/reference/packages/tracing/) for complete documentation
- Check [Troubleshooting](/docs/reference/packages/tracing/troubleshooting/) for common issues
