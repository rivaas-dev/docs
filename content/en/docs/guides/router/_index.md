...
The [validation package](/docs/reference/packages/validation/) offers multiple strategies you can use after binding:
...
- **Sub-microsecond routing and high throughput** — See [Router Performance](/docs/reference/packages/router/performance/) for current latency and throughput numbers.
...
- **API Reference**: Check the [API Reference](/docs/reference/packages/router/) for detailed documentation

## Need Help?

- **Troubleshooting**: See [Common Issues](/docs/reference/packages/router/troubleshooting/)
