...
- **Real-world impact**: Negligible for most applications (<1% overhead). See [Router Performance](/docs/reference/packages/router/performance/) for current figures.
...
**Learn more:** See the [Route Constraints reference](/docs/reference/packages/router/route-constraints/) for all available constraints.
...
- **Constraints**: See all [route constraints](/docs/reference/packages/router/route-constraints/) available
