...
See the [Middleware Reference](/docs/reference/packages/router/middleware/) for the full list and options.
...
- **Middleware Reference**: See all [built-in middleware options](/docs/reference/packages/router/middleware/)
