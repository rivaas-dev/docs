...
When you use the **app** package, your handlers receive `app.Context`, which has built-in methods: `c.TraceID()`, `c.SpanID()`, `c.SetSpanAttribute()`, `c.AddSpanEvent()`, and more. See the [app observability guide](/docs/guides/app/observability/).
